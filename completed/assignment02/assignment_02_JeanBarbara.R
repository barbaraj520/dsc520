...
person_df1 <- read.csv("C:/Users/79bar/dsc520/data/tidynomicon/person.csv")
str(person_df1)
...
person_df2 <- read.csv("C:/Users/79bar/dsc520/data/tidynomicon/person.csv", stringsAsFactors= TRUE)
str(person_df2)

## Read the file `data/scores.csv` to `scores_df`
## Display summary statistics using the `summary()` function
scores_df <-read.csv("C:/Users/79bar/dsc520/data/scores.csv")
summary(scores_df)
...
excel_sheets("C:/Users/79bar/dsc520/data/G04ResultsDetail2004-11-02.xls")
...
voter_turnout_df1 <- read_excel("C:/Users/79bar/dsc520/data/G04ResultsDetail2004-11-02.xls",
...
voter_turnout_df2 <-  read_excel("C:/Users/79bar/dsc520/data/G04ResultsDetail2004-11-02.xls",
...
db <- dbConnect(RSQLite::SQLite(),"C:/Users/79bar/dsc520/data/tidynomicon/example.db" )
